...
class MergeSortImprovedTest : public testing::TestWithParam<SortTestParam> {};

TEST_P(MergeSortImprovedTest, MergeSortCompareWithStdSort) {
  const auto& params = MergeSortImprovedTest::GetParam();
  ...
  
  {
    ...
    MergeSortImproved(tapePool, inFilename, "tmp", true, 100).perform(outFilename);
...
INSTANTIATE_TEST_SUITE_P(SimpleTapesMergeSorts, MergeSortImprovedTest,
...
INSTANTIATE_TEST_SUITE_P(TwoPowSizedMergeSorts, MergeSortImprovedTest,
...
INSTANTIATE_TEST_SUITE_P(ThreePowSizedMergeSorts, MergeSortImprovedTest,
